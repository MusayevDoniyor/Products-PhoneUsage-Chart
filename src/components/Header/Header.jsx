...
export default function Header({ navLink }) {
  return (
    <header className="flex justify-between py-5 px-7 bg-gray-900 sticky top-1 items-center shadow-md z-50">
      <div>
                ...
                className={
                  ({ isActive }) =>
                    isActive
                      ...
                      : "text-gray-300 hover:text-blue-400" // Inactive link color
                }
                to={link.href}
              >
                {link.title}
